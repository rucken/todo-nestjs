...
export class StatusesController {
    ...
    @ApiResponse({
        status: HttpStatus.CREATED, type: OutStatusDto,
    ...
    @ApiResponse({
        status: HttpStatus.OK, type: OutStatusDto,
    ...
    async delete(
        ...
        try {
            return plainToClass(OutStatusDto,
    ...
    @HttpCode(HttpStatus.OK)
    @ApiResponse({
        status: HttpStatus.OK, type: OutStatusesDto,
        description: ''
    })
    @ApiResponse({ status: HttpStatus.FORBIDDEN, description: 'Forbidden.' })
